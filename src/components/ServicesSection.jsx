      ...
      <div className="flex flex-col md:flex-row  items-center justify-between gap-12 lg:gap-24">
        ...
        <div className="md:w-1/3 w-full -mt-8">
          ...
          <p className="text-gray-600 text-lg mb-4 md:w-4/5">
            Discuss your goals, determine sucess metrix, identify problems.
          </p>
          <div>
          ...
          <button className="mt-8 bg-indigo-600 text-white px-6 py-2 cursor-pointer rounded-full hover:bg-indigo-800 transition-colors">
            Get Started
          </button>
        </div>
        {/* service cards */}
